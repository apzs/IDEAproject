...
<div class="container" style="width: 400px;">
    <h3 style="text-align: center">欢迎新用户</h3>
    <form action="/login/register" method="post">
        ...
        <div class="form-group">
            <label>密码：</label>
            <input aria-describedby="basic-addon1" class="form-control" placeholder="请输入密码" name="password1" type="password">
        </div>
        <div class="form-group">
            <label>再次输入密码：</label>
            <input aria-describedby="basic-addon1" class="form-control" placeholder="请再次输入密码" name="password2" type="password">
        </div>
        ...
        <div  class="form-group" style="text-align: center">
            <input class="btn btn-primary" style="width: 100px" type="submit" value="注册">
        </div>
    </form>
</div>
            <div id="msg">${msg}</div>
